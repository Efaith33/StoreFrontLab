...
namespace StoreFront2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,City,State,DirectReportID,ContactEmail,DepartmentID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,LastName,City,State,DirectReportID,ContactEmail,DepartmentID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
